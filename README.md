...
Killswitch — это политика брандмауэра «исходящее по умолчанию запрещено» плюс пять
разрешающих правил. Пока туннель жив, наружу ходит только он. Если ядро упадёт или вы
