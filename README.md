...
| Свой сервер мимо VPN | Cloudflare Tunnel, ngrok и подобные. Если сайт живёт на этом же компьютере, заворачивать его обратный канал в туннель — значит гонять каждый запрос лишний круг через зарубежный сервер |
