...
Приложение раз в шесть часов смотрит, нет ли нового релиза. Если есть — на кнопке
меню загорается точка, а в меню появляется строка «Обновление». Дальше одна кнопка:
скачать и поставить.
