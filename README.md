...
- **Блокировки и обходы** — четыре переключателя: трекеры, российские сайты мимо VPN,
  починка Kodik, App Store напрямую. Списки короткие и предсказуемые: резать рекламу
